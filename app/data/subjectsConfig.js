...
export const subjectsConfig = {
  ...
  SIID246: {
    ...
    specialSheet: "246 (Gross1)", specialRow: 3, specialCols: [23, 24, 25, 26, 27], specialNames: ["Special 1", "Special 2", "Special 3", "Special 4", "Special 5"],
    labSections: ["Body Wall & Axilla", "Upper Limb", "Head & Neck", "Lower Limb", "Ultrasographic Study"],
    labTrigger: 1,
    lectureHandoutCols: [14, 15, 16, 17, 18, 19, 20, 21],
    lectureHandoutNames: ["Handout 1", "Handout 2", "Handout 3", "Lecture 1", "Lecture 2", "Lecture 3", "CLO", "CLO Finished"],
    lectureVideoCols: [], lectureSummaryCol: 22,
  },
  SIID247: {
  ...
  SIID255: {
    ...
    specialSheet: "255 (Gross2)", specialRow: 3, specialCols: [23, 24, 25, 26, 27], specialNames: ["Special 1", "Special 2", "Special 3", "Special 4", "Special 5"],
