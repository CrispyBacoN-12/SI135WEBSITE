...
const [CLOASSESSMENT, setCLOASSESSMENT] = useState([]);
  ...
  const url = `https://docs.google.com/spreadsheets/d/1BycR2oOEWS5FlGe5KZLcwm6nPuCpHvmn8p-3SCo3rcg/gviz/tq?tqx=out:json&sheet=257%20(Immunno)&tq=select%20*%20limit%2099`;
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8">
        <div className="flex flex-col md:flex-row md:items-center rounded-lg mt-10">
          ...
          <div className="text-left space-y-1 font-preuksa">
            ...
            <p className="text-3xl text-gray-700 italic">SIID257</p>
            <p className="text-base text-gray-600">Immune responses and inflammation</p>
            <div className="flex gap-2 items-center flex-wrap">
              <a
                href="https://sirirajcanvas.instructure.com/courses/1082"
                target="_blank"
