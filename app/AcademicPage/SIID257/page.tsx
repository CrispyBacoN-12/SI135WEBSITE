...
const [CLOASSESSMENT, setCLOASSESSMENT] = useState([]);
  ...
  const url = `https://docs.google.com/spreadsheets/d/1BycR2oOEWS5FlGe5KZLcwm6nPuCpHvmn8p-3SCo3rcg/gviz/tq?tqx=out:json&sheet=257%20(Immuno)&tq=select%20*%20limit%2099`;
