...
const [CLOASSESSMENT, setCLOASSESSMENT] = useState([]);
  ...
  const url = `https://docs.google.com/spreadsheets/d/1BycR2oOEWS5FlGe5KZLcwm6nPuCpHvmn8p-3SCo3rcg/gviz/tq?tqx=out:json&sheet=249%20(KUB)&tq=select%20*%20limit%2022`;
        ...
        <div className="flex flex-col md:flex-row md:items-center rounded-lg mt-10">
          ...
          <div className="text-left space-y-1 font-preuksa">
            ...
            <div className="flex gap-2 items-center flex-wrap">
              <a
                href="https://sirirajcanvas.instructure.com/courses/1079"
                target="_blank"
              ...
              >
               ...
               <a
                href="https://www.youtube.com/playlist?list=PLnWAv0tkYmKHH3AFukgyhbw4Eiel61Fl0"
                target="_blank"
                rel="noopener noreferrer"
